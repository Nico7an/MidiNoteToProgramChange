...
This plugin converts incoming MIDI notes into MIDI Program Change messages. It is designed for musicians and producers who want to trigger preset changes (Quad Cortex, Valeton GP-5/GP-20, Harley Benton DNAFx Git, etc.) using a MIDI track, keyboard or pads without complex routing.
...
- **Audio Pass-through**: Declares stereo audio I/O for 100% compatibility with hosts like Ableton Live, Bitwig, Reaper, and other DAWs.
